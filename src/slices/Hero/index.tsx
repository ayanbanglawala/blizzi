      ...
      <div className="grid">
        <div className="grid h-screen place-items-center">
          <div className="grid auto-rows-min place-items-center text-center">
            ...
            <div className="hero-subheading mt-12 text-5xl font-semibold text-sky-950">
            ...
            <Button
              ...
              className="hero-button mt-12 rounded-xl bg-orange-500 px-5 py-4 text-center text-xl font-bold tracking-wide text-white uppercase transition-colors duration-150 hover:bg-orange-700 md:text-2xl"
            />
          </div>
        </div>
